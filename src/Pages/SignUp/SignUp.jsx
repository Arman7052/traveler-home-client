        ...
        <div  className='flex flex-col justify-center items-center text-center md:flex-row md:justify-evenly'>
            ...
            <div className='flex justify-center items-center min-h-screen'>
                <div className='flex flex-col max-w-md p-6 rounded-md sm:p-10 bg-gray-100 text-gray-900'>
                    ...
                    <div className='flex justify-center items-center rounded-md space-x-2 border  p-2 bg-blue-500 hover:bg-teal-500  border-teal-300 border-rounded cursor-pointer'>
                        <FcGoogle size={32} />
